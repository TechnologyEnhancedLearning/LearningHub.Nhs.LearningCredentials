...
BEGIN
	INSERT INTO [dsp].[VerifiableCredential]
			   ([CredentialName],[ClientSystemId],[ClientSystemCredentialId],[ScopeName],[ClaimPrefix],[PeriodUnitId],[PeriodQty],[Deleted],[CreateUserId],[CreateDate],[AmendUserId],[AmendDate])
